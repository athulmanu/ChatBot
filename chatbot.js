$(document).ready(function () {
    ...
    function determineChatData() {
        // Example: Determine site-specific content
        var hostname = window.location.hostname;

        if (hostname.includes("ecommerce")) {
            // Set up e-commerce related questions
            Fake = [
                'Hi there! How can I help you with your order?',
                'Are you looking for something specific?',
                'We have great deals today!',
                'Can I help you track your order?',
                'What product are you interested in?',
            ];
        } else if (hostname.includes("education")) {
            // Set up education related questions
            Fake = [
                'Hi there! Are you looking for course information?',
                'Need help with assignments?',
                'Can I guide you to our resources?',
